within ;
model SystemForFMI_480x1
  "钠电1500V储能包 — 480串1并 (480电芯)，先并后串，适用于大型乘用车/SUV(800V平台)、重型商用车、电网级储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 480 "串联组数";
  parameter Integer Np = 1 "每组并联单体数";
...
<p><strong>SystemForFMI_480x1</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 1 个电芯并联成组，480 组串联</li>
<li><b>电芯数量</b>：480 (480×1)</li>
<li><b>额定电压</b>：约 1488.0 V (480 × 3.1 V)</li>
<li><b>额定能量</b>：约 74.4 kWh (50 Ah × 3.1 V × 1P × 480S)</li>
<li><b>适用场景</b>：大型乘用车/SUV(800V平台)、重型商用车、电网级储能</li>
