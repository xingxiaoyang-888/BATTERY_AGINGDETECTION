within ;
model SystemForFMI_192x2
  "800V高性能平台 — 192串2并 (384电芯)，先并后串，适用于大型乘用车/SUV(800V平台)、重型商用车、电网级储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 192 "串联组数";
  parameter Integer Np = 2 "每组并联单体数";
...
<p><strong>SystemForFMI_192x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，192 组串联</li>
<li><b>电芯数量</b>：384 (192×2)</li>
<li><b>额定电压</b>：约 595.2 V (192 × 3.1 V)</li>
<li><b>额定能量</b>：约 59.5 kWh (50 Ah × 3.1 V × 2P × 192S)</li>
