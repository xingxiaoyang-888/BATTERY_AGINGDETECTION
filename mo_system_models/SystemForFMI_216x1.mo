within ;
model SystemForFMI_216x1
  "800V长续航平台 — 216串1并 (216电芯)，先并后串，适用于乘用车动力电池(800V高压平台)、快充车型"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 216 "串联组数";
...
<p><strong>SystemForFMI_216x1</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 1 个电芯并联成组，216 组串联</li>
<li><b>电芯数量</b>：216 (216×1)</li>
<li><b>额定电压</b>：约 669.6 V (216 × 3.1 V)</li>
<li><b>额定能量</b>：约 33.5 kWh (50 Ah × 3.1 V × 1P × 216S)</li>
<li><b>适用场景</b>：乘用车动力电池(800V高压平台)、快充车型</li>
