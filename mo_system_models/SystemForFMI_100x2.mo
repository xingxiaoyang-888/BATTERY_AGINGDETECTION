within ;
model SystemForFMI_100x2
  "400V大容量平台 — 100串2并 (200电芯)，先并后串，适用于乘用车动力电池(400V平台)、工商业储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 100 "串联组数";
...
<p><strong>SystemForFMI_100x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，100 组串联</li>
<li><b>电芯数量</b>：200 (100×2)</li>
<li><b>额定电压</b>：约 310.0 V (100 × 3.1 V)</li>
<li><b>额定能量</b>：约 31.0 kWh (50 Ah × 3.1 V × 2P × 100S)</li>
