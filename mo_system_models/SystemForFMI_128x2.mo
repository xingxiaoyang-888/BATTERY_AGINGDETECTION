within ;
model SystemForFMI_128x2
  "钠电400V大容量包 — 128串2并 (256电芯)，先并后串，适用于乘用车动力电池(400V+平台)、大型工商业储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 128 "串联组数";
...
<p><strong>SystemForFMI_128x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，128 组串联</li>
<li><b>电芯数量</b>：256 (128×2)</li>
<li><b>额定电压</b>：约 396.8 V (128 × 3.1 V)</li>
<li><b>额定能量</b>：约 39.7 kWh (50 Ah × 3.1 V × 2P × 128S)</li>
<li><b>适用场景</b>：乘用车动力电池(400V+平台)、大型工商业储能</li>
