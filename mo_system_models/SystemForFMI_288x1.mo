within ;
model SystemForFMI_288x1
  "钠电900V高压包 — 288串1并 (288电芯)，先并后串，适用于大型乘用车/SUV(800V平台)、重型商用车、电网级储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 288 "串联组数";
...
<p><strong>SystemForFMI_288x1</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 1 个电芯并联成组，288 组串联</li>
<li><b>电芯数量</b>：288 (288×1)</li>
<li><b>额定电压</b>：约 892.8 V (288 × 3.1 V)</li>
<li><b>额定能量</b>：约 44.6 kWh (50 Ah × 3.1 V × 1P × 288S)</li>
