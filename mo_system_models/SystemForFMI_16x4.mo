within ;
model SystemForFMI_16x4
  "储能单簇 — 16串4并 (64电芯)，先并后串，适用于轻型商用车、48V/72V微混系统、户用储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 16 "串联组数";
  parameter Integer Np = 4 "每组并联单体数";
...
<p><strong>SystemForFMI_16x4</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 4 个电芯并联成组，16 组串联</li>
<li><b>电芯数量</b>：64 (16×4)</li>
<li><b>额定电压</b>：约 49.6 V (16 × 3.1 V)</li>
<li><b>额定能量</b>：约 9.9 kWh (50 Ah × 3.1 V × 4P × 16S)</li>
