within ;
model SystemForFMI_48x2
  "小型乘用车高容 — 48串2并 (96电芯)，先并后串，适用于小型乘用车(150V平台)、户用储能、轻型物流车"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 48 "串联组数";
...
<p><strong>SystemForFMI_48x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，48 组串联</li>
<li><b>电芯数量</b>：96 (48×2)</li>
<li><b>额定电压</b>：约 148.8 V (48 × 3.1 V)</li>
<li><b>额定能量</b>：约 14.9 kWh (50 Ah × 3.1 V × 2P × 48S)</li>
<li><b>适用场景</b>：小型乘用车(150V平台)、户用储能、轻型物流车</li>
