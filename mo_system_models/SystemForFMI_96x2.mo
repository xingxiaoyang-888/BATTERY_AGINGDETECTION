within ;
model SystemForFMI_96x2
  "乘用车大容量包 — 96串2并 (192电芯)，先并后串，适用于乘用车动力电池(400V平台)、工商业储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 96 "串联组数";
...
<p><strong>SystemForFMI_96x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，96 组串联</li>
<li><b>电芯数量</b>：192 (96×2)</li>
<li><b>额定电压</b>：约 297.6 V (96 × 3.1 V)</li>
<li><b>额定能量</b>：约 29.8 kWh (50 Ah × 3.1 V × 2P × 96S)</li>
