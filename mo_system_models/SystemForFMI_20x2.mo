within ;
model SystemForFMI_20x2
  "低压储能模组 — 20串2并 (40电芯)，先并后串，适用于轻型商用车、48V/72V微混系统、户用储能"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 20 "串联组数";
...
<p><strong>SystemForFMI_20x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，20 组串联</li>
<li><b>电芯数量</b>：40 (20×2)</li>
<li><b>额定电压</b>：约 62.0 V (20 × 3.1 V)</li>
<li><b>额定能量</b>：约 6.2 kWh (50 Ah × 3.1 V × 2P × 20S)</li>
