within ;
model SystemForFMI_8x2
  "微型模组 — 8串2并 (16电芯)，先并后串，适用于微型储能模组、两轮电动车、便携式电源"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 8 "串联组数";
...
<p><strong>SystemForFMI_8x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，8 组串联</li>
<li><b>电芯数量</b>：16 (8×2)</li>
<li><b>额定电压</b>：约 24.8 V (8 × 3.1 V)</li>
<li><b>额定能量</b>：约 2.5 kWh (50 Ah × 3.1 V × 2P × 8S)</li>
<li><b>适用场景</b>：微型储能模组、两轮电动车、便携式电源</li>
