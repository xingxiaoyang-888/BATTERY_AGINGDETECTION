within ;
model SystemForFMI_12x2
  "小型模组 — 12串2并 (24电芯)，先并后串，适用于轻型电动车(LEV)、小型AGV、通信基站备电"
  import Modelica.Units.SI;

  // === 结构参数 (编译时固定，决定FMU的数组维度) ===
  parameter Integer Ns = 12 "串联组数";
...
<p><strong>SystemForFMI_12x2</strong> 是一个预配置的钠离子电池包系统模型，专用于 FMU 导出。</p>
<ul>
<li><b>拓扑</b>：先并后串 (SeriesParallel) — 2 个电芯并联成组，12 组串联</li>
<li><b>电芯数量</b>：24 (12×2)</li>
<li><b>额定电压</b>：约 37.2 V (12 × 3.1 V)</li>
<li><b>额定能量</b>：约 3.7 kWh (50 Ah × 3.1 V × 2P × 12S)</li>
<li><b>适用场景</b>：轻型电动车(LEV)、小型AGV、通信基站备电</li>
